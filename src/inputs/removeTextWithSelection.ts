...
const removeTextWithSelection = (
  ...
  // 4. Update virtual selection to be after the inserted text
  // 5. Load text end selection inline last text part
  // 6. Load new start selection inline and all inlines in end selection block after end selection inline
  // 7. Load new start selection block and all blocks after end selection block
  ...
  /////////////////////////////////////////////////////////////////////////////////
  // 4. Update selection to be after the inserted text
  vSel.start = selStart;
  ...
  /////////////////////////////////////////////////////////////////////////////////
  // 5. Load end selection inline last text part
...
export default removeTextWithSelection;
